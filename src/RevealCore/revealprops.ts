...
export interface RevealProps {
    ...
    /**Flags whether to include the current fragment in the URL, so that reloading brings you to the same fragmentposition */
    ...
    autoSlideMethod?: any | null;

    /**Specify the average time in seconds that you think you will spend
    presenting each slide. This is used to show a pacing timer in the
    speaker view */
    defaultTiming?: any | null;
    ...
    /**Transition style */
    transition?: 'slide' | 'fade' | 'convex' | 'concave' | 'zoom' | 'none'; // none/fade/slide/convex/concave/zoom

    /**Transition speed */
    transitionSpeed?: 'default' | 'fast' | 'slow'; // default/fast/slow

    /**Transition style for full page slide backgrounds */
    backgroundTransition?: 'slide' | 'fade' | 'convex' | 'concave' | 'zoom' | 'none';
